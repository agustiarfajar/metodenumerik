...
<body>
    <center>
    <h1>Metode Bagi Dua</h1>
        <table border="1" width="70%" style="border-collapse:collapse">
            <tr>
                <td colspan="9">
                    <b>Soal Nomor 1:</b>
					<p>f(x) = x<sup>3</sup> + 5x<sup>2</sup> - 10x - 4
					<p>Gunakan metode bagi dua untuk menentukan akar dari persamaan tersebut 
        ...
        <?php 
			...
			// Deklarasi nilai galat, a, b, iterasi awal, lebar selang awal
            $galat = 0.0001;
            $a = 1.3;
			$b = 2;
            $i = 1;
            ...
            while (abs($lebar) >= $galat) {
				// Rumus mencari nilai c
                $c = ($a+$b)/2;
				// Substitusi nilai a dan c ke dalam fungsi persamaan
				$fa = fungsi($a);
				$fc = fungsi($c);
			...
			echo "<tr><td colspan='9'><br>
					Pada iterasi ke ".$i." memenuhi kondisi |a - b| &lt; &#949;, maka iterasi terhenti, dan diperoleh akar hampiran 
